...
export const GameFlowChart: React.FC<GameFlowChartProps> = memo(
  ({
    timeline,
    quarterBoundaries,
    runs,
    ...
    const yDomain = useMemo(() => {
      ...
      return [-Math.ceil(maxDiff / 5) * 5, Math.ceil(maxDiff / 5) * 5] as [number, number];
    }, [summary.largestLead.home, summary.largestLead.away]);
...
GameFlowChart.displayName = "GameFlowChart";
