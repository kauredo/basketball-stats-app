 ...
 */
export const QuarterBreakdown: React.FC<QuarterBreakdownProps> = memo(
  ({ homeTeamName, awayTeamName, scoreByPeriod, currentQuarter, homeScore, awayScore }) => {
...
QuarterBreakdown.displayName = "QuarterBreakdown";
