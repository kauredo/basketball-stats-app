  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">League Standings</h1>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="bg-gray-800 rounded-lg px-4 py-2 border border-gray-700">
            ...
            <div className="text-2xl font-bold text-white">{standingsData?.totalGames || 0}</div>
          </div>
        </div>
      </div>
                ...
                {sortedStandings.map((team, index) => (
                  <tr
                    ...
                    className={`hover:bg-gray-700/50 transition-colors ${
                      index < 4 ? "bg-green-900/10" : index >= sortedStandings.length - 2 ? "bg-red-900/10" : ""
                    }`}
                  >
                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      <div className="flex space-x-1">
                        ...
                        {[...Array(5 - team.last5.length)].map((_, i) => (
                          <span
                            key={`empty-${i}`}
                            className="w-5 h-5 rounded bg-gray-700 text-gray-500 text-xs font-medium flex items-center justify-center"
                          >
                            -
                          </span>
                        ))}
      ...
      <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
        ...
        <div className="flex flex-wrap gap-6 text-sm">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-gray-400">OPPG</span>
