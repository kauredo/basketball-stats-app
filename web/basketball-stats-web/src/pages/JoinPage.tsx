      ...
      <div className="max-w-md w-full">
        {status === "loading" ? (
          <div className="text-center">
            ...
            <h1 className="text-xl font-bold text-surface-900 dark:text-white mb-2">Loading...</h1>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-surface-600 dark:text-surface-400">Redirecting you to the app...</p>
          </div>
        ) : (
          <div className="text-center">
