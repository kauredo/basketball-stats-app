...
- [x] Cleanup TODO.md TODOs
- [x] PlayerDetail in web not optimized for mobile
- [x] All ShotRecordingModal, Quick stat modal, assist modal, etc should be splitting into sections for each team. Both web and mobile
