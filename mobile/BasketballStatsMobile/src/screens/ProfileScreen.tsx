...
export default function ProfileScreen() {
  const { user, selectedLeague, userLeagues, logout, selectLeague } = useAuthStore();
          ...
          <View style={styles.section}>
            ...
            <View style={styles.leagueCard}>
              <View style={styles.leagueInfo}>
                ...
                <Text style={styles.leagueType}>{selectedLeague.league_type}</Text>
                <Text style={styles.leagueSeason}>Season: {selectedLeague.season}</Text>
